  ...
  <div>
    ...
    <div>
      <bottomNav class="bottomNav">
        ...
        <router-link class="index-bottom-btn" to="/bbs/postlist">
    ...
    <div>
      <van-popup v-model="showPopup" position="top" :style="{ height: '30%' }" class="quickBtn">
        <div class="c-icon iconfont logo cust-icon" v-bind:class="animation.animation1"  @click="$router.push({name:'addPostHead'})">
